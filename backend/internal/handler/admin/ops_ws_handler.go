...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["aysub-admin", "jwt.<token>"].
	// - We always select "aysub-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"aysub-admin"},
}
