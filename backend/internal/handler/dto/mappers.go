...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		PermissionMode:      service.NormalizeAPIKeyPermissionModeNoError(k.PermissionMode),
		AllowedModels:       service.NormalizeAPIKeyAllowedModels(k.AllowedModels),
		AllowedEndpoints:    k.AllowedEndpoints,
		PermissionUpdatedAt: k.PermissionUpdatedAt,
		Quota:               k.Quota,
