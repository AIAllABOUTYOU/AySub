...
func TestVerifyOrderPublicReturnsLegacyOrderState(t *testing.T) {
	...
	for _, field := range []string{"id", "amount", "pay_amount", "fee_rate", "currency", "payment_type", "order_type", "refund_amount", "refund_reason", "refund_requested_at", "refund_requested_by", "refund_request_reason", "plan_id"} {
