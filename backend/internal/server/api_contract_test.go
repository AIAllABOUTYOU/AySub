		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "AySub",
					...
					service.SettingKeySiteName:     "AySub",
			...
			wantJSON: `{
				...
				"data": {
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":null},"antigravity":{"daily":null,"weekly":null,"monthly":null},"gemini":{"daily":null,"weekly":null,"monthly":null},"openai":{"daily":null,"weekly":null,"monthly":null},"xai":{"daily":null,"weekly":null,"monthly":null}},
...
func (r *stubUsageLogRepo) GetOperationalReports(ctx context.Context, startTime, endTime time.Time, granularity string, limit int) (*usagestats.OperationalReportsResponse, error) {
	return nil, errors.New("not implemented")
}
