...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/operational-reports", h.Admin.Dashboard.GetOperationalReports)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/inspection/run", h.Admin.Account.RunInspection)
		accounts.POST("/import/codex-session/preview", h.Admin.Account.PreviewCodexSessionImport)
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.GET("/strategy", h.Admin.Channel.GetStrategyView)
		...
		channels.POST("/batch-status", h.Admin.Channel.BatchUpdateStatus)
		channels.POST("/batch-pricing", h.Admin.Channel.BatchReplacePricing)
		channels.POST("/copy-strategy", h.Admin.Channel.CopyStrategy)
