...
// raw control bytes that some broken clients place inside JSON strings.
...
// NormalizeLenientJSONRequestBody escapes raw JSON string control bytes before
// the strict JSON parser sees the body. It does not repair malformed structure.
