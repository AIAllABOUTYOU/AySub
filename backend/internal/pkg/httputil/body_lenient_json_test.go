...
func TestNormalizeLenientJSONRequestBody_acceptsClientControlCharsInStrings(t *testing.T) {
	tests := []struct {
		name    string
		body    []byte
		path    string
...
func TestNormalizeLenientJSONRequestBody_keepsInvalidStructureInvalid(t *testing.T) {
	tests := []struct {
		name string
		body []byte
	}{
...
func TestNormalizeLenientJSONRequestBody_allowsHTTPRequestsWithClientControlChars(t *testing.T) {
...
func TestNormalizeLenientJSONRequestBody_rejectsExpansionPastLimit(t *testing.T) {
