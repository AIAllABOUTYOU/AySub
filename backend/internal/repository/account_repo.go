...
// SetRateLimitedIfLater atomically extends the account rate-limit boundary.
// Concurrent upstream responses must never shorten a later reset observed by
// another request or instance.
