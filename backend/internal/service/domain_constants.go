...
const (
	...
	SettingKeyRegistrationEmailDomainBlacklist         = "registration_email_domain_blacklist"          // 注册邮箱域名黑名单（JSON 数组）
	SettingKeyRegistrationEmailAliasRestrictionEnabled = "registration_email_alias_restriction_enabled" // 是否拦截邮箱别名注册
	...
	SettingKeyHomeConfig                  = "home_config"                   // 默认首页结构化配置（JSON object）
