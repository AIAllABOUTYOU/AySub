...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "AySub", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "AySub", "https://example.com/reset", "en-US"))
