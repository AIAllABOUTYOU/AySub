...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "permission_mode", Type: field.TypeString, Size: 20, Default: "inherit"},
		{Name: "allowed_models", Type: field.TypeJSON, Nullable: true},
		{Name: "allowed_endpoints", Type: field.TypeJSON, Nullable: true},
		{Name: "permission_updated_at", Type: field.TypeTime, Nullable: true},
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "xai", "gemini"}},
