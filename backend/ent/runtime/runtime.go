...
func init() {
	...
	// apikeyDescPermissionMode is the schema descriptor for permission_mode field.
	apikeyDescPermissionMode := apikeyFields[8].Descriptor()
	// apikey.DefaultPermissionMode holds the default value on creation for the permission_mode field.
	apikey.DefaultPermissionMode = apikeyDescPermissionMode.Default.(string)
	// apikey.PermissionModeValidator is a validator for the "permission_mode" field. It is called by the builders before save.
	apikey.PermissionModeValidator = apikeyDescPermissionMode.Validators[0].(func(string) error)
