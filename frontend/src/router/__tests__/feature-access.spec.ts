...
describe('feature route guard', () => {
  ...
  it('waits for public settings before deciding payment access', async () => {
  ...
  ])('does not treat a failed %s settings load as disabled', async (_name, meta, path) => {
  ...
  it.each([
    ...
    ['risk control', { requiresRiskControl: true }, { risk_control_enabled: false }, '/admin/settings'],
