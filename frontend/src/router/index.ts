/**
 * Vue Router configuration for AySub frontend
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: () => import('@/views/user/ExperienceCenterView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      title: 'Experience Center',
      titleKey: 'experienceCenter.title',
      descriptionKey: 'experienceCenter.description'
    }
  },
  {
    path: '/profile',
  ...
  {
    path: '/admin/accounts/inspection',
    name: 'AdminAccountInspection',
    component: () => import('@/views/admin/AccountInspectionView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/key-usage', '/models', '/status', '/setup', '/payment/result', '/payment/airwallex', '/legal']
...
router.beforeEach(async (to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      const siteName = appStore.siteName || 'AySub'
