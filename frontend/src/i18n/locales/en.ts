export default {
  ...
  setup: {
    title: 'AySub Setup',
    description: 'Configure your AySub instance',
    database: {
  ...
  keys: {
    ...
    permissions: {
      column: 'Permissions',
      title: 'Model and Endpoint Permissions',
      description: 'Inherit uses the group and channel capabilities. Restrict only allows the models and endpoints below.',
      inherit: 'Inherit',
      restrict: 'Restrict',
      allowedModels: 'Allowed Models',
      allowedModelsPlaceholder: 'gpt-4o\ngemini-*\nclaude-3-5-sonnet-*',
      allowedModelsHint: 'One model per line or comma. A trailing * matches model prefixes. Empty means no model is allowed.',
      allowedEndpoints: 'Allowed Endpoints',
      allowedEndpointsHint: 'Only selected gateway endpoints can be called with this key.',
  ...
  requestLogs: {
    title: 'Request Logs',
    description: 'View successful and failed requests in one place for API key, model, endpoint, and upstream troubleshooting',
    ...
    stats: {
      ...
      errors: 'Page errors',
      avgDuration: 'Page avg duration',
      errorRate: 'Page error rate'
    },
    reports: {
      title: 'Operational Reports',
      description: 'Summarize request trend, error trend, model cost, channel health, user spend, and key spend for the selected range',
      failedToLoad: 'Failed to load operational reports',
      ...
      channelHealthRanking: 'Channel health ranking',
      userSpendingRanking: 'User spending ranking',
      keySpendingRanking: 'Key spending ranking',
      requests: 'Requests',
      cost: 'Spend',
    ...
    filters: {
      ...
      searchPlaceholder: 'Search request_id / model / error / user / key / account / channel'
    },
    columns: {
      kind: 'Kind',
      status: 'Status',
  ...
  publicStatus: {
    title: 'System Status',
    subtitle: 'Public service health summary',
    refresh: 'Refresh',
    refreshing: 'Refreshing...',
    generatedAt: 'Updated',
    disabledTitle: 'Status page is disabled',
    disabledDescription: 'The public status page has not been enabled by an administrator.',
    ...
    noModels: 'No public models to display',
    channels: 'Channel Summary',
    activeChannels: 'Active Channels',
    disabledChannels: 'Disabled / Error',
    noChannels: 'No public channels to display',
    platform: 'Platform',
    active: 'Active',
    total: 'Total',
    modelCountShort: 'Models',
    recentEvents: 'Recent Events',
    noRecentEvents: 'No public events in the last 24 hours',
    endpoint: 'Endpoint',
    statusCode: 'Status Code',
    hidden: 'Hidden by administrator',
  },
  ...
  modelMarketplace: {
    ...
    pricing: {
      ...
      requestSummary: '{price} / request',
      imageSummary: '{price} / request'
    },
    calculator: {
      ...
      originalCost: 'Estimated Original Cost',
      multipliedCost: 'After Multiplier ({multiplier}x)',
      lowestChannel: 'Lowest Channel Price',
      highestChannel: 'Highest Channel Price',
      noResult: 'Select a model and group to estimate cost. Models without pricing do not produce a result.'
    }
  },

  // Experience Center (user-facing)
  experienceCenter: {
    title: 'Experience Center',
    description: 'Try chat, image generation, and upcoming media capabilities with your own API key',
    ...
    controls: {
      ...
      keyHint: 'Experience requests call the current AySub gateway with the selected API key and follow model and endpoint permissions.'
    },
    actions: {
      send: 'Send',
      sending: 'Sending...',
    ...
    video: {
      ...
      empty: 'Video task status, preview, and download will appear here',
    ...
    audio: {
      ...
      submit: 'Run Audio Task',
      empty: 'Speech generation or audio recognition results will appear here',
    ...
    errors: {
      ...
      enterPrompt: 'Enter content first',
      selectAudioFile: 'Select an audio file first'
    }
  },
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. aysub-backups), choose a region',
    ...
    users: {
      ...
      editKeyPermissions: 'Edit Key Permissions',
      keyPermissionsAdminHint: 'Admin overrides directly control which models and endpoints this key can call. Inherit uses the user group and channel capabilities.',
      keyPermissionsUpdated: 'Key permissions updated',
      keyPermissionsUpdateFailed: 'Failed to update key permissions',
    ...
    groups: {
      ...
      peakRate: {
        enable: 'Enable peak-hour multiplier',
    ...
    channels: {
      ...
      strategy: {
        ...
        show: 'Strategy View',
        hide: 'Hide Strategy',
        title: 'Channel Strategy View',
        window: 'Window: {start} - {end}',
        channel: 'Channel',
        groups: 'Groups and Accounts',
        models: 'Models and Mapping',
        policy: 'Policy',
        health: 'Health and Cost',
        lastError: 'Latest Error',
        groupSummary: '{count} groups, {active}/{total} accounts available',
        modelSummary: '{pricing} pricing rules, {models} priced models, {mappings} mappings',
        notRestricted: 'No model restriction',
        requests: '{count} requests',
        errorRate: 'Error rate {rate}',
        cost: 'User cost {actual} / account cost {account}',
        empty: 'No channel strategy data',
        batchPricingTitle: 'Batch Replace Model Pricing',
        batchPricingHint: 'Replace model pricing for the selected platform across {count} selected channels.',
        pricingPlatform: 'Pricing Platform',
        batchPricingEmpty: 'Add at least one pricing rule',
        batchPricingSuccess: 'Updated pricing for {count} channels',
        batchPricingError: 'Failed to batch update pricing',
        copyStrategyTitle: 'Copy Channel Strategy',
        sourceChannel: 'Source Channel',
        copyTargets: 'Copy to {count} selected channels',
        copyModelPricing: 'Copy model pricing',
        copyModelMapping: 'Copy model mapping',
        copyFlags: 'Copy strategy flags',
        copyAccountStatsPricing: 'Copy account-stats pricing',
        sourceRequired: 'Select a source channel',
        copyOptionRequired: 'Select at least one copy option',
        copyStrategySuccess: 'Copied strategy to {count} channels',
        copyStrategyError: 'Failed to copy strategy',
        loadError: 'Failed to load channel strategy view',
        batchStatusSuccess: 'Updated {count} channel statuses',
        batchStatusError: 'Failed to batch update channel status'
      },
      billingMode: {
        token: 'Token',
        perRequest: 'Per Request',
    ...
    riskControl: {
      ...
      cyberPolicyExcludeBan: 'Exclude cyber_policy from ban count',
      cyberPolicyExcludeBanHint: 'Keep cyber_policy audit logs but exclude them from automatic ban accumulation.',
    ...
    accounts: {
      ...
      createSparkShadowConfirm: 'Create a Spark shadow linked to "{name}"? It shares parent credentials and only serves Spark models.',
      ...
      dataImport: 'Import',
      xaiCookieTokenImport: 'Import Grok Tokens',
      xaiCookieTokenExport: 'Export Grok2API format',
      ...
      xaiCookieTokenImportTitle: 'Import Grok Tokens',
      xaiCookieTokenImportHint: 'Upload txt/json/zip files to create xAI / Grok Cookie accounts in bulk. Multiple files, folder scanning, and zip archives are supported. One token per line, sso=token, full Cookie fragments, and grok2api ssoBasic JSON are accepted.',
      ...
      xaiCookieTokenImportSelectFile: 'Choose TXT/JSON/ZIP files, or select a folder',
      xaiCookieTokenImportChooseFiles: 'Choose Files',
      xaiCookieTokenImportChooseFolder: 'Choose Folder',
      xaiCookieTokenImportReadingFiles: 'Reading files...',
      xaiCookieTokenImportSourceSummary: 'Loaded {count} sources, first: {first}',
      xaiCookieTokenImportSelectedSources: 'Importable sources: {count}',
      xaiCookieTokenImportSkippedSources: 'Skipped sources: {count}',
      xaiCookieTokenImportFilesLoaded: 'Loaded {count} importable files',
      xaiCookieTokenImportNoSupportedFiles: 'No importable TXT/JSON files found',
      xaiCookieTokenImportUnsupportedFile: 'Only TXT/JSON/ZIP files are supported',
      xaiCookieTokenImportInvalidZip: 'Invalid ZIP structure',
      xaiCookieTokenImportZipReadFailed: 'Failed to read ZIP',
      xaiCookieTokenImportUnsupportedZipMethod: 'Unsupported ZIP compression method {method}',
      xaiCookieTokenImportZipUnsupportedBrowser: 'This browser cannot decompress deflate zip entries. Use an uncompressed zip or select the folder directly.',
      ...
      codexSessionImport: 'Import Codex/ChatGPT',
      codexSessionImportTitle: 'Import Codex / ChatGPT Accounts',
      codexSessionImportHint: 'Paste or upload ChatGPT Web sessions, Codex auth.json, sub2api, 9router, CPA, Cockpit, AxonHub, or Codex-Manager JSON. Multiple files, folder scanning, and zip archives are supported. Accounts are created as OpenAI OAuth accounts.',
      codexSessionImportWarning: 'The content may contain access_token, refresh_token, or sessionToken credentials. Do not expose the raw import text in chats, tickets, or public pages after importing.',
      codexSessionImportFile: 'Import file',
      codexSessionImportSelectFile: 'Choose JSON/TXT/ZIP files, select a folder, or paste content directly',
      codexSessionImportChooseFiles: 'Choose Files',
      codexSessionImportChooseFolder: 'Choose Folder',
      codexSessionImportReadingFiles: 'Reading files...',
      codexSessionImportSourceSummary: 'Loaded {count} sources, first: {first}',
      codexSessionImportSelectedSources: 'Importable sources: {count}',
      codexSessionImportSkippedSources: 'Skipped sources: {count}',
      codexSessionImportFilesLoaded: 'Loaded {count} importable files',
      codexSessionImportNoSupportedFiles: 'No importable JSON/TXT files found',
      codexSessionImportUnsupportedFile: 'Only JSON/TXT/ZIP files are supported',
      codexSessionImportInvalidZip: 'Invalid ZIP structure',
      codexSessionImportZipReadFailed: 'Failed to read ZIP',
      codexSessionImportUnsupportedZipMethod: 'Unsupported ZIP compression method {method}',
      codexSessionImportZipUnsupportedBrowser: 'This browser cannot decompress deflate zip entries. Use an uncompressed zip or select the folder directly.',
      codexSessionImportContent: 'Import content',
      codexSessionImportPlaceholder: 'Paste an accessToken, ChatGPT session JSON, Codex auth.json, or JSON exported by GPTSession2CPAandSub2API. Batch files are submitted as separate import sources.',
      codexSessionImportName: 'Account name prefix (optional)',
      codexSessionImportAccountConcurrency: 'Account concurrency',
      codexSessionImportUpdateExisting: 'Update credentials when an existing account matches',
      codexSessionImportPreviewProgress: 'Scanning batch {current}/{total}; checked {processed}/{total_items} sources',
      codexSessionImportProgress: 'Importing batch {current}/{total}; processed {processed}/{total_items} accounts',
      codexSessionImportPreviewMismatch: 'The preview no longer matches the selected sources. Select the files again and retry.',
      codexSessionImportInvalidConcurrency: 'Account concurrency must be a non-negative integer',
      codexSessionImportInvalidPriority: 'Priority must be a non-negative integer',
      codexSessionImportHTTP401Title: 'Found {count} account(s) with HTTP 401',
      codexSessionImportHTTP401Description: 'These accounts may no longer be valid. Import them anyway, or filter them out and continue with the remaining accounts.',
      codexSessionImportHTTP401Include: 'Import anyway',
      codexSessionImportHTTP401Filter: 'Filter and continue',
      codexSessionImportResult: 'Import Result',
      codexSessionImportResultSummary: 'Created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      codexSessionImportOpenSource: 'Compatible formats reference open-source project:',
      codexSessionImportButton: 'Start Import',
      codexSessionImporting: 'Importing...',
      codexSessionImportEmpty: 'Paste import content or choose a file first',
      codexSessionImportReadFailed: 'Failed to read file',
      codexSessionImportSuccess: 'Import completed: created {created}, updated {updated}, skipped {skipped}',
      codexSessionImportCompletedWithErrors: 'Import completed with errors: created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      codexSessionImportFailed: 'Failed to import Codex / ChatGPT accounts',
      codexSessionImportError: 'Error',
      codexSessionImportWarningLabel: 'Warning',
	  ...
	  dataExportedSkippedShadows: 'Data exported. Skipped {count} Spark shadow account(s); recreate and configure them after restore.',
      dataExportFailed: 'Failed to export data',
      dataImportTitle: 'Import Data',
      dataImportHint: 'Upload exported JSON files to import accounts and proxies. Multiple files, folder scanning, and zip archives are supported; multiple exports are merged before import.',
      ...
      dataImportSelectFile: 'Choose JSON/ZIP files, or select a folder',
      dataImportReadingFiles: 'Reading files...',
      dataImportSourceSummary: 'Loaded {count} sources, first: {first}',
      dataImportSelectedSources: 'Importable sources: {count}',
      dataImportSkippedSources: 'Skipped sources: {count}',
      dataImportFilesLoaded: 'Loaded {count} importable files',
      dataImportNoSupportedFiles: 'No importable JSON files found',
      dataImportUnsupportedFile: 'Only JSON/ZIP files are supported',
      dataImportInvalidZip: 'Invalid ZIP structure',
      dataImportZipReadFailed: 'Failed to read ZIP',
      dataImportUnsupportedZipMethod: 'Unsupported ZIP compression method {method}',
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself, not configured by AySub, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within AySub.',
      schedulerScore: {
        hint: 'OpenAI scheduler scores calculated for the current filtered pool and each account group. The display is group / base score / sticky score; +∞ means sticky routing currently outranks ordinary scores.',
        ungrouped: 'Ungrouped'
      },
      ...
      bulkEdit: {
        ...
        customHeadersReplaceHint: 'Saving replaces the existing custom headers on every target account with the rows below.',
        customHeadersClearHint: 'Saving clears custom request headers on every target account.',
      ...
      xai: {
        baseUrlHint: 'Leave default for official xAI API',
        apiKeyHint: 'Your xAI API Key',
        cookieBaseUrl: 'Grok Base URL',
        cookieType: 'Grok Cookie',
        cookieDesc: 'grok.com sso',
        ssoCookie: 'Grok sso Cookie',
        ...
        keepExistingCookie: 'Leave empty to keep existing cookie',
        keepExistingCfCookies: 'Leave empty to keep existing Cloudflare cookies',
        keepExistingValue: 'Leave empty to keep existing value',
      },
      anthropic: {
		apiKeyAuthScheme: 'API key authentication',
		apiKeyAuthSchemeDesc: 'Some Anthropic-compatible services require Authorization: Bearer instead of x-api-key.',
		apiKeyAuthSchemeXApiKey: 'x-api-key (default)',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another AySub instance.',
      ...
      customHeadersDesc: 'Add custom HTTP headers for all requests from this account',
      customHeadersExpand: 'Expand',
      customHeadersCollapse: 'Collapse',
      customHeadersAdd: 'Add Header',
      customHeadersKeyPlaceholder: 'X-Custom-Header',
      customHeadersValuePlaceholder: 'value',
      customHeadersErrors: {
        tooMany: 'No more than 64 request headers are allowed',
        nameRequired: 'Header name is required',
        invalidName: 'Header name is invalid or too long',
      ...
      openaiQuotaReset: {
		...
		resetTooltipShadow: 'Shadow accounts cannot reset quota; reset the parent account instead',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          ...
          rewardModeFixed: 'Fixed Amount',
          rewardModeRandom: 'Random Range',
          ...
          rewardMinAmount: 'Minimum Reward Amount',
          rewardMaxAmount: 'Maximum Reward Amount',
          rewardRangeHint: 'Each successful check-in randomly grants an amount between the minimum and maximum. The actual amount is stored in the check-in record.',
        },
        publicStatus: {
          ...
          viewLink: 'View public status page',
          enabled: 'Enable Public Status Page',
          enabledHint: 'When off, /status and the anonymous status API return 404.',
          showModels: 'Show Models',
          showModelsHint: 'Shows model names and counts only; never accounts or keys.',
          showChannels: 'Show Channel Summary',
          showChannelsHint: 'Shows platform-level total, active, and model counts only.',
          showRecentIncidents: 'Show Recent Events',
          showRecentIncidentsHint: 'Shows redacted error summaries only; never request bodies or internal stacks.',
        },
        riskControl: {
          title: 'Risk Control',
          ...
          cyberSessionBlockHint: 'After an upstream cyber_policy hit, block only the same session for the configured duration.',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for AySub end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for AySub end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'AySub',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'All Your AI Sub Hub',
      ...
      betaPolicy: {
        ...
        userIds: 'User IDs',
        userIdsHint: 'Leave empty for a global rule. User-specific rules take priority over global rules.',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to AySub',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">AySub is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of AySub, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to AySub',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the AySub AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    admin: {
      ...
      confirmRefundStatus: 'Confirm Refund Status',
      refundSuccess: 'Refund successful',
      refundStatusConfirmed: 'Refund status confirmed',
      ...
      daySuffix: 'd',
      ops: {
        title: 'Payment Operations Acceptance',
        window: 'Audit events and current order state in the last {days} days',
        productionReadiness: 'Production readiness metrics',
        callback: {
          title: 'Callbacks & Consistency',
          desc: 'Payment notifications, amount checks, and fulfillment anomalies',
          failures: 'Callback failures',
          inconsistencies: 'Order inconsistencies',
          fulfillmentFailed: 'Fulfillment failed',
          paidNotCompleted: 'Paid not completed',
          stalePending: 'Stale pending',
        },
        refunds: {
          title: 'Refunds',
          desc: 'Refund requests, processing, and failure state',
        ...
        providers: {
          title: 'Payment Instances',
          desc: 'Provider availability and refund capability',
          enabled: 'Enabled instances',
          disabled: 'Disabled instances',
          unavailable: 'Unavailable instances',
          refundEnabled: 'Refund enabled',
          userRefundEnabled: 'User refund enabled',
        },
      },
