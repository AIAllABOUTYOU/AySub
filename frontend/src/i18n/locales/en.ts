export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      xaiCookieTokenImportHint: 'Upload a txt/json file to create xAI / Grok Cookie accounts in bulk. One token per line, sso=token, full Cookie fragments, and grok2api ssoBasic JSON are accepted.',
      ...
      xaiCookieTokenImportSelectFile: 'Please select a TXT or JSON file',
      ...
      codexSessionImportHint: 'Paste or upload ChatGPT Web sessions, Codex auth.json, sub2api, 9router, CPA, Cockpit, AxonHub, or Codex-Manager JSON. Accounts are created as OpenAI OAuth accounts.',
      ...
      codexSessionImportSelectFile: 'Choose a JSON/TXT file or paste content directly',
      codexSessionImportContent: 'Import content',
      codexSessionImportPlaceholder: 'Paste an accessToken, ChatGPT session JSON, Codex auth.json, or JSON exported by GPTSession2CPAandSub2API.',
