export default {
  ...
  experienceCenter: {
    title: '体验中心',
    description: '使用自己的 API 密钥快速体验聊天、画图与后续多媒体能力',
    comingSoon: '待开放',
    tabs: {
      chat: '聊天',
      image: '画图',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 aysub-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    riskControl: {
      ...
      cyberPolicyExcludeBan: 'cyber_policy 不计入封禁次数',
      cyberPolicyExcludeBanHint: '开启后，cyber_policy 仍记录风控日志，但不参与自动封禁累计。',
      banThreshold: '封禁触发次数',
    ...
    accounts: {
      ...
      createSparkShadowConfirm: '为“{name}”创建共享母账号凭据、仅服务 Spark 模型的影子账号？',
      createSparkShadowSuccess: 'Spark 影子账号创建成功',
      createSparkShadowFailed: 'Spark 影子账号创建失败',
      autoRefresh: '自动刷新',
      ...
      dataImport: '导入',
      xaiCookieTokenImport: '导入 Grok Token',
      xaiCookieTokenExport: '导出 Grok2API 格式',
      ...
      xaiCookieTokenImportTitle: '导入 Grok Token',
      xaiCookieTokenImportHint: '上传 txt/json/zip 文件批量创建 xAI / Grok Cookie 账号；支持多文件、文件夹扫描和 zip，兼容每行一个 token、sso=token、完整 Cookie 片段和 grok2api 的 ssoBasic JSON。',
      xaiCookieTokenImportWarning: '导入会创建新的 xAI Cookie 账号；已存在或重复的 token 会自动跳过。',
      xaiCookieTokenImportFile: 'Token 文件',
      xaiCookieTokenImportSelectFile: '请选择 TXT/JSON/ZIP、多选文件或文件夹',
      xaiCookieTokenImportChooseFiles: '选择文件',
      xaiCookieTokenImportChooseFolder: '选择文件夹',
      xaiCookieTokenImportReadingFiles: '正在读取文件...',
      xaiCookieTokenImportSourceSummary: '已读取 {count} 个来源，首个：{first}',
      xaiCookieTokenImportSelectedSources: '可导入来源：{count} 个',
      xaiCookieTokenImportSkippedSources: '已跳过来源：{count} 个',
      xaiCookieTokenImportFilesLoaded: '已读取 {count} 个可导入文件',
      xaiCookieTokenImportNoSupportedFiles: '未找到可导入的 TXT/JSON 文件',
      xaiCookieTokenImportUnsupportedFile: '仅支持 TXT/JSON/ZIP',
      xaiCookieTokenImportInvalidZip: 'ZIP 文件结构无效',
      xaiCookieTokenImportZipReadFailed: 'ZIP 读取失败',
      xaiCookieTokenImportUnsupportedZipMethod: '不支持的 ZIP 压缩方法 {method}',
      xaiCookieTokenImportZipUnsupportedBrowser: '当前浏览器不支持解压 deflate zip，请改用未压缩 zip 或直接选择文件夹',
      ...
      codexSessionImport: '导入 Codex/ChatGPT',
      codexSessionImportTitle: '导入 Codex / ChatGPT 账号',
      codexSessionImportHint: '粘贴或上传 ChatGPT Web session、Codex auth.json、sub2api、9router、CPA、Cockpit、AxonHub 或 Codex-Manager 格式；支持多文件、文件夹扫描和 zip，系统会自动创建 OpenAI OAuth 账号。',
      codexSessionImportWarning: '内容包含 access_token、refresh_token 或 sessionToken 等敏感凭证。导入后请不要在聊天、工单或公开页面中泄露原文。',
      codexSessionImportFile: '导入文件',
      codexSessionImportSelectFile: '可选择 JSON/TXT/ZIP、多选文件或文件夹，也可以直接粘贴内容',
      codexSessionImportChooseFiles: '选择文件',
      codexSessionImportChooseFolder: '选择文件夹',
      codexSessionImportReadingFiles: '正在读取文件...',
      codexSessionImportSourceSummary: '已读取 {count} 个来源，首个：{first}',
      codexSessionImportSelectedSources: '可导入来源：{count} 个',
      codexSessionImportSkippedSources: '已跳过来源：{count} 个',
      codexSessionImportFilesLoaded: '已读取 {count} 个可导入文件',
      codexSessionImportNoSupportedFiles: '未找到可导入的 JSON/TXT 文件',
      codexSessionImportUnsupportedFile: '仅支持 JSON/TXT/ZIP',
      codexSessionImportInvalidZip: 'ZIP 文件结构无效',
      codexSessionImportZipReadFailed: 'ZIP 读取失败',
      codexSessionImportUnsupportedZipMethod: '不支持的 ZIP 压缩方法 {method}',
      codexSessionImportZipUnsupportedBrowser: '当前浏览器不支持解压 deflate zip，请改用未压缩 zip 或直接选择文件夹',
      codexSessionImportContent: '导入内容',
      codexSessionImportPlaceholder: '粘贴 accessToken、ChatGPT session JSON、Codex auth.json，或 GPTSession2CPAandSub2API 导出的 JSON。批量文件会作为独立来源随导入一起提交。',
      codexSessionImportName: '账号名前缀（可选）',
      codexSessionImportAccountConcurrency: '账号并发数',
      codexSessionImportUpdateExisting: '匹配到已有账号时更新凭证',
      codexSessionImportPreviewProgress: '正在预检第 {current}/{total} 批，已扫描 {processed}/{total_items} 个来源',
      codexSessionImportProgress: '正在导入第 {current}/{total} 批，已处理 {processed}/{total_items} 个账号',
      codexSessionImportPreviewMismatch: '预检结果与导入来源不一致，请重新选择文件后再试',
      codexSessionImportInvalidConcurrency: '账号并发数必须是大于或等于 0 的整数',
      codexSessionImportInvalidPriority: '优先级必须是大于或等于 0 的整数',
      codexSessionImportHTTP401Title: '发现 {count} 个 HTTP 401 账号',
      codexSessionImportHTTP401Description: '这些账号可能已失效。请选择仍然导入，或过滤后继续导入其余账号。',
      codexSessionImportHTTP401Include: '仍然导入',
      codexSessionImportHTTP401Filter: '过滤后继续',
      codexSessionImportResult: '导入结果',
      codexSessionImportResultSummary: '创建 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
      codexSessionImportOpenSource: '兼容格式参考开源项目：',
      codexSessionImportButton: '开始导入',
      codexSessionImporting: '导入中...',
      codexSessionImportEmpty: '请先粘贴导入内容或选择文件',
      codexSessionImportReadFailed: '读取文件失败',
      codexSessionImportSuccess: '导入完成：创建 {created}，更新 {updated}，跳过 {skipped}',
      codexSessionImportCompletedWithErrors: '导入完成但有错误：创建 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
      codexSessionImportFailed: 'Codex / ChatGPT 账号导入失败',
      codexSessionImportError: '错误',
      codexSessionImportWarningLabel: '警告',
      moreActions: '更多操作',
      dataActions: '数据操作',
      toolActions: '工具',
      viewColumns: '列显示',
      ...
      dataExported: '数据导出成功',
	  dataExportedSkippedShadows: '数据已导出，已跳过 {count} 个 Spark 影子账号；恢复后请重新创建并配置影子账号。',
      dataExportFailed: '数据导出失败',
      dataImportTitle: '导入数据',
      dataImportHint: '上传导出的 JSON 文件以批量导入账号与代理；支持多文件、文件夹扫描和 zip，多个导出文件会合并后导入。',
      ...
      dataImporting: '导入中...',
      dataImportSelectFile: '请选择 JSON/ZIP、多选文件或文件夹',
      dataImportReadingFiles: '正在读取文件...',
      dataImportSourceSummary: '已读取 {count} 个来源，首个：{first}',
      dataImportSelectedSources: '可导入来源：{count} 个',
      dataImportSkippedSources: '已跳过来源：{count} 个',
      dataImportFilesLoaded: '已读取 {count} 个可导入文件',
      dataImportNoSupportedFiles: '未找到可导入的 JSON 文件',
      dataImportUnsupportedFile: '仅支持 JSON/ZIP',
      dataImportInvalidZip: 'ZIP 文件结构无效',
      dataImportZipReadFailed: 'ZIP 读取失败',
      dataImportUnsupportedZipMethod: '不支持的 ZIP 压缩方法 {method}',
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 AySub 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 AySub 端解除该限制。',
      schedulerScore: {
        hint: '按当前筛选池和账号所属分组计算 OpenAI 调度基础分。显示格式为“分组 / 基础分 / 粘性分”；+∞ 表示当前粘性会话优先级不可被普通分数覆盖。',
        ungrouped: '未分组'
      },
      ...
      openaiQuotaReset: {
		...
		resetTooltipShadow: '影子账号不能重置额度，请在母账号上操作',
      ...
      bulkEdit: {
        ...
        customHeadersReplaceHint: '保存后会用下方请求头替换所有目标账号的现有配置。',
        customHeadersClearHint: '保存后会清空所有目标账号的自定义请求头。',
      ...
      openai: {
        ...
        planType: '订阅档位（手动覆盖）',
        planTypeDesc: '手动纠正本账号的 ChatGPT 订阅档位。令牌刷新或命中 429 时，系统可能用检测到的真实档位覆盖此设置。',
      ...
      xai: {
        ...
        keepExistingCookie: '留空则保留现有 Cookie',
        keepExistingCfCookies: '留空则保留现有 Cloudflare Cookies',
        keepExistingValue: '留空则保留现有值',
      },
      anthropic: {
		apiKeyAuthScheme: 'API Key 认证方式',
		apiKeyAuthSchemeDesc: '部分 Anthropic 兼容服务要求使用 Authorization: Bearer，而不是 x-api-key。',
		apiKeyAuthSchemeXApiKey: 'x-api-key（默认）',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 AySub 实例的场景。',
      ...
      noProxy: '无代理',
      customHeaders: '请求头',
      customHeadersDesc: '为此账号的所有请求添加自定义 HTTP 请求头',
      customHeadersExpand: '展开',
      customHeadersCollapse: '收起',
      customHeadersAdd: '添加请求头',
      customHeadersKeyPlaceholder: 'X-Custom-Header',
      customHeadersValuePlaceholder: 'value',
      customHeadersErrors: {
        tooMany: '请求头数量不能超过 64 条',
        nameRequired: '请求头名称不能为空',
        invalidName: '请求头名称格式无效或过长',
        blockedName: '该请求头涉及认证、连接或会话状态，禁止覆盖',
        invalidValue: '请求头值包含非法字符或过长',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          ...
          rewardMode: '奖励模式',
          rewardModeFixed: '固定金额',
          rewardModeRandom: '随机范围',
          rewardAmount: '签到奖励金额',
          rewardAmountHint: '每次成功签到发放到用户余额的金额。0 表示只记录签到，不发放余额。',
          rewardMinAmount: '最低奖励金额',
          rewardMaxAmount: '最高奖励金额',
          rewardRangeHint: '用户每次签到会在最低和最高金额之间随机获得奖励；实际发放金额会写入签到记录。',
        },
        publicStatus: {
          title: '公开状态页',
        ...
        riskControl: {
          ...
          cyberSessionBlockHint: '命中上游 cyber_policy 后，在设定时间内阻止相同会话再次请求，不影响同一密钥的其他会话。',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 AySub 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 AySub 用户登录',
      ...
      betaPolicy: {
        ...
        userIds: '指定用户 ID',
        userIdsHint: '留空表示全局规则；填写后该规则仅对指定用户生效，并优先于全局规则。',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 AySub',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">AySub 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 AySub 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 AySub',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 AySub AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    admin: {
      ...
      confirmRefund: '确认退款',
      confirmRefundStatus: '确认退款状态',
      refundSuccess: '退款成功',
      refundStatusConfirmed: '退款状态已确认',
      refundInfo: '退款信息',
      refundEnabled: '允许退款',
      alreadyRefunded: '已退款',
      deductBalance: '扣除余额',
