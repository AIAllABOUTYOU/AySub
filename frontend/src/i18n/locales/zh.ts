export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      xaiCookieTokenImportHint: '上传 txt/json 文件批量创建 xAI / Grok Cookie 账号；兼容每行一个 token、sso=token、完整 Cookie 片段和 grok2api 的 ssoBasic JSON。',
      xaiCookieTokenImportWarning: '导入会创建新的 xAI Cookie 账号；已存在或重复的 token 会自动跳过。',
      xaiCookieTokenImportFile: 'Token 文件',
      xaiCookieTokenImportSelectFile: '请选择 TXT 或 JSON 文件',
      ...
      codexSessionImportHint: '粘贴或上传 ChatGPT Web session、Codex auth.json、sub2api、9router、CPA、Cockpit、AxonHub 或 Codex-Manager 格式，系统会自动创建 OpenAI OAuth 账号。',
      ...
      codexSessionImportSelectFile: '可选择 JSON 或 TXT 文件，也可以直接粘贴内容',
      codexSessionImportContent: '导入内容',
      codexSessionImportPlaceholder: '粘贴 accessToken、ChatGPT session JSON、Codex auth.json，或 GPTSession2CPAandSub2API 导出的 JSON。',
