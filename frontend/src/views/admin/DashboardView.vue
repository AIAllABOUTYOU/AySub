    ...
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <div v-if="canUseBatchImage" class="card p-4">
          ...
          <button
            type="button"
            class="group flex w-full items-center gap-3 rounded-lg bg-gray-50 p-3 text-left transition-colors hover:bg-sky-50 dark:bg-dark-800/50 dark:hover:bg-sky-900/20"
