/**
 * Core Type Definitions for AySub Frontend
 */
...
export type AccountType = 'oauth' | 'setup-token' | 'apikey' | 'cookie' | 'upstream' | 'bedrock' | 'service_account'
...
export interface Account {
  ...
  proxy?: Proxy
	...
	quota_dimension?: 'global' | 'spark' | string
	parent_email?: string
